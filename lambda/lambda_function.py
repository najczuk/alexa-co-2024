...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Welcome, when you're ready just say: start a quiz"
...
class StartIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        attr["question_entry"] = utils.draw_question_entry()
        question = attr["question_entry"]["question"]

        response_builder = handler_input.response_builder
        response_builder.speak("Ok, here is the question: " + question)
...
class AnswerIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        question_entry = attr["question_entry"]
        is_ans_correct = utils.compare_slots(handler_input.request_envelope.request.intent.slots, question_entry['answer'])
        
        if is_ans_correct:
            speech = "nice, "
            handler_input.attributes_manager.session_attributes = attr
        else:
            speech = "Ohh not this time, "
